...
public class Quaternion {
	...
	public Quaternion nlerp(Quaternion dest, float lerpFactor, boolean shortest){
		...
		return correctedDest.sub(this).mul(new Vector3f(lerpFactor, lerpFactor, lerpFactor)).add(this).normalized();
	}
	...
	public Quaternion slerp(Quaternion dest, float lerpFactor, boolean shortest){
		...
		return this.mul(new Vector3f(srcFactor)).add(correctedDest.mul(new Vector3f(destFactor)));
	}
	...
	public Quaternion set(Quaternion quater){
		this.x = quater.getX();
		this.y = quater.getY();
		this.z = quater.getZ();
		this.w = quater.getW();
